function [sys,x0,str,ts,simStateCompliance] = ...
    SMC(t,x,u,flag, CoeF1, CoeF2, CoeF3, para)
...
switch flag,
  ...
  %%%%%%%%%%%
  case 3,
    sys=mdlOutputs(t,x,u, CoeF1, CoeF2, CoeF3, para);
...
%=============================================================================
%
function sys=mdlOutputs(t,x,u, CoeF1, CoeF2, CoeF3, para)
...
deno = alpha * b1x + beta * b2x + gamma * b3x;

tau = (alpha*b1ueq1 + beta*b2ueq2 + gamma*b3ueq3 - eta*sign(S) - k*S)/deno;
